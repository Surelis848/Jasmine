describe('My whatCanIDrink function', function(){
    ...
    describe('Checks age', function() {
        ...
        it('should return Beer when called as whatCanIDrink(18)', function(){
        ...
        it('should return Whiskey when called as whatCanIDrink(30)', function(){
        ...
        it('should be unable to return a drink when called as whatCanIDrink(140)', function(){
            ...
            expect(result).toBe("Sorry. I cannot tell what drink because that age is incorrect");
        });
    });
});